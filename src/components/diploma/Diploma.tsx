  ...
  return (
    <article className='diploma'>
      <div className='diploma__info'>
        <h2 className='diploma__info-title'>
          Выдаём <span className='wavy-underline'>дипломы</span> участникам
        </h2>
        <p className='diploma__info-text paragraph--small'>
      ...
      <div className='diploma__card-wrapper'>
        <DiplomaCard
          name='Гасенко Алина'
          place='1'
          category='во Всероссийском конкурсе детских рисунков &#10;«Моё счастливое лето»&#10;Возраст от 0 до 4 лет, г. Калуга'
          date='15.08.2022'
        />
      </div>
    </article>
