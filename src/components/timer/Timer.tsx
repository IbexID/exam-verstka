    ...
    setInterval(() => {
      ...
      const daysToSet =
        Math.floor(diff / 1000 / 60 / 60 / 24).toString().length > 1
          ...
          : '0' + Math.floor(diff / 1000 / 60 / 60 / 24).toString()
      const hoursToSet =
        Math.floor((diff / 1000 / 60 / 60) % 24).toString().length > 1
          ? Math.floor((diff / 1000 / 60 / 60) % 24).toString()
          : '0' + Math.floor((diff / 1000 / 60 / 60) % 24).toString()
      const minutesToSet =
        Math.floor((diff / 1000 / 60) % 60).toString().length > 1
          ? Math.floor((diff / 1000 / 60) % 60).toString()
          : '0' + Math.floor((diff / 1000 / 60) % 60).toString()
      setDays(daysToSet)
      setHours(hoursToSet)
